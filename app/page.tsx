        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="w-9 h-9 rounded-full bg-gradient-to-br from-amber-400 via-orange-400 to-rose-400 p-0.5 shadow-md group-hover:shadow-lg transition-shadow">
                <div className="w-full h-full rounded-full bg-white flex items-center justify-center">
                  <span className="text-sm font-bold bg-gradient-to-br from-amber-500 to-rose-500 bg-clip-text text-transparent">
                    K
                  </span>
                </div>
              </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-0">
            ...
            {hasError && (
              <div className="mb-8 p-5 bg-rose-50 border border-rose-200 rounded-2xl">
                <p className="text-rose-600 font-medium">エラーが発生しました</p>
          ...
          <aside className="lg:w-80 shrink-0">
            <div className="lg:sticky lg:top-24 space-y-6">
              {/* Profile Card */}
              <div className="bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 rounded-3xl p-6 border border-amber-100/50 animate-fade-in-up opacity-0 animation-delay-300">
                {/* Avatar */}
                <div className="flex flex-col items-center text-center mb-6">
                  <div className="w-24 h-24 rounded-full bg-gradient-to-br from-amber-400 via-orange-400 to-rose-400 p-1 shadow-lg shadow-orange-200/50 mb-4">
                    <div className="w-full h-full rounded-full bg-white flex items-center justify-center">
                      <span className="text-3xl font-bold bg-gradient-to-br from-amber-500 to-rose-500 bg-clip-text text-transparent font-[family-name:var(--font-noto-serif)]">
                        K
                      </span>
                    </div>
                  </div>
                  <h2 className="text-xl font-bold bg-gradient-to-r from-amber-600 to-rose-500 bg-clip-text text-transparent">
                    Kayashi
                  </h2>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed mb-6">
                  こんにちは、かやしです。プログラミングやテクノロジーが好きで、日々の学びや発見をこのブログで発信しています。新しい技術を学ぶことが大好きです。
                </p>
                ...
                <div className="flex items-center justify-center gap-3">
                  <Link
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white border border-border hover:bg-amber-50 hover:border-amber-200 hover:scale-110 transition-all duration-300 shadow-sm"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                    </svg>
      ...
      <footer className="border-t border-border mt-16 py-8">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
            <p>&copy; {new Date().getFullYear()} Kayashi. All rights reserved.</p>
